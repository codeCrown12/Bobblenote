...
<body>
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-exclamation-triangle-fill flex-shrink-0 me-2" viewBox="0 0 16 16" role="img" aria-label="Warning:">
                ...
                <strong>Notice!</strong> This competition has expired/concluded and can no longer be seen by prospective participants. Please <a href="renewcomp.php?comp_id=<?php echo $compid ?>" class="text-decoration-underline">Renew!</a>
              </div>
            </div>
          </div>
          <?php
                    ...
                    <div class="card-body">
                      <!-- Tab links -->
                        ...
                        <div class="card-footer bg-white">
                          ...
                          <button class="btn btn-success btn-sm <?php if($comp_data['comp_status'] != "expired" || $comp_data['payout_requested'] == "true") echo "disabled" ?>" data-bs-toggle="modal" data-bs-target="#awards">Request payout</button>
                        </div>
                  </div>
              </div>
              <div class="col-md-5">
              ...
              <div class="modal fade" id="awards" tabindex="-1" aria-labelledby="awardsLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p id="gen_inst" style="display: none;">Please input individual email addresses & prizes of the awardees starting from highest award to lowest. <br><small><strong>Note: </strong>The sum of all the amounts inputed must <strong>not</strong> be greater than your total deposit.</small></p>
    ...
    <script src="js/managecomp.js"></script>
</body>
</html>